...
#define DATE "built on: Fri Mar  5 11:18:44 2021 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','a','d','a','m',
    '/','D','o','c','u','m','e','n','t','s','/','t','o','o','-','g',
    'o','o','d','-','t','o','-','p','y','-','t','e','s','t','i','n',
    'g','/','.','b','u','i','l','d','o','z','e','r','/','a','n','d',
    'r','o','i','d','/','p','l','a','t','f','o','r','m','/','b','u',
    'i','l','d','-','a','r','m','e','a','b','i','-','v','7','a','/',
    'b','u','i','l','d','/','p','y','t','h','o','n','-','i','n','s',
    't','a','l','l','s','/','m','y','a','p','p','/','i','n','c','l',
